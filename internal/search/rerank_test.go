...
// TestReranker_RecencyMultiplierFromConfig verifies the Reranker honours
// RecencyBoostMultiplier from config — a larger multiplier produces a higher
// FinalScore for a matching recent file (REF-043).
